 ...
 * 
 * Title field works as TvShow identifier because for the sample we don't have a
 * unique identifier ready to be used for this sample.
 * 
...
public class TvShow implements Serializable {
	...
	public TvShow(String title, String poster, String fanArt,
		...
		episodes = new ChapterCollection();
	}
