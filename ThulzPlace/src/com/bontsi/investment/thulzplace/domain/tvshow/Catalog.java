 ...
 */
package com.bontsi.investment.thulzplace.domain.tvshow;
...
/**
 * Contains all the available TvShows for this sample. All this hard coded data
 * simulates some information obtained from an external service.
 * 
...
public class Catalog {
	...
	/**
	 * Default constructor. All this hardcoded information is going to be used
	 * as mocked information for the demo application.
	 */
	@SuppressWarnings("PMD.AvoidDuplicateLiterals")
	public Catalog() {
		tvShows = new LinkedHashSet<TvShow>();
		...
		tvShow.addEpisode(new Chapter("...And the Bag's in the River",
				"2008-02-10"));
		...
		tvShow.addEpisode(new Chapter("A No-Rough-Stuff-Type Deal'",
				"2008-03-09"));
		tvShows.add(tvShow);
		...
		tvShow.addEpisode(new Chapter("All the Best Cowboys Have Daddy Issues",
				"2004-12-08"));
		tvShow.addEpisode(new Chapter(
				"Whatever the Case May Be the Case May Be", "2005-01-05"));
		...
		tvShow.addEpisode(new Chapter("The Greater Good (a.k.a. Sides)",
				"2005-05-04"));
		...
		tvShow.addEpisode(new Chapter("Darkness on the Edge of Town",
				"2013-05-08"));
		...
		tvShow.addEpisode(new Chapter("Nothing Good Happens After 2 A.M.",
				"2006-04-10"));
		...
		tvShow.addEpisode(new Chapter("Cripples, Bastards, and Broken Things",
				"2011-05-08"));
		...
		tvShow.addEpisode(new Chapter("The Grasshopper Experiment",
				"2007-11-12"));
		tvShow.addEpisode(new Chapter("The Cooper-Hofstadter Polarization",
				"2008-03-17"));
		tvShow.addEpisode(new Chapter("The Loobenfeld Decay", "2008-03-24"));
		tvShow.addEpisode(new Chapter("The Pancake Batter Anomaly",
				"2008-03-31"));
		...
		tvShow.addEpisode(new Chapter("The Pork Chop Indeterminacy",
				"2008-05-05"));
		...
		tvShow = new TvShow(
				...
				10);
		tvShow.addEpisode(new Chapter("The One Where Monica Gets A Roommate",
				"1994-09-22"));
		tvShow.addEpisode(new Chapter("The One With The Sonogram At The End",
				"1994-09-29"));
		tvShow.addEpisode(new Chapter("The One With The Thumb", "1994-10-06"));
		tvShow.addEpisode(new Chapter("The One With George Stephanopoulos",
				"1994-10-13"));
		tvShow.addEpisode(new Chapter(
		...
		tvShow.addEpisode(new Chapter("The One Where Nana Dies Twice",
				"1994-11-10"));
		tvShow.addEpisode(new Chapter("The One Where Underdog Gets Away",
				"1994-11-17"));
		...
		tvShow = new TvShow(
				...
				26);
		tvShow.addEpisode(new Chapter("Simpsons Roasting on an Open Fire",
				"1989-12-17"));
		tvShow.addEpisode(new Chapter("Bart the Genius", "1990-01-14"));
		tvShow.addEpisode(new Chapter("Homer's Odyssey", "1990-01-21"));
		tvShow.addEpisode(new Chapter("There's No Disgrace Like Home",
				"1990-01-28"));
	...
	/**
	 * We should return a full clone of TvShow objects inside catalog because
	 * all this data is in memory and anyone can change it if we don't return
	 * only copies, but this is just a sample!
	 * 
	 ...
	 * 
	 * We should return a clone of TvShow objects inside catalog because all
	 * this data is in memory and anyone can change it. But, this is just a
	 * sample!
	 * 
	 * @param tvShowId
	 *            used to search inside the catalog.
	...
	public TvShow getTvShowById(String tvShowId) throws TvShowNotFoundException {
		final TvShow result = searchTvShowById(tvShowId);
		if (result == null) {
