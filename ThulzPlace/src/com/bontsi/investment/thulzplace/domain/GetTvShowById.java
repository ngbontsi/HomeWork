 ...
 * 
 * This interactor can execute onTvShowNotFound Callback method if there is no
 * any tv show that matches with the tvShowId passed as parameter. Other
 * possible result is the execution of OnConnectionError when there is no
 * internet connection and the client code executes this interactor.
 * 
