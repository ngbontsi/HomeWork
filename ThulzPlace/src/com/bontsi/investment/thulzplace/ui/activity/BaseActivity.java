...
import com.bontsi.investment.thulzplace.di.ActivityModule;
 ...
 * library configuration and some methods common to every activity.
 * 
...
public abstract class BaseActivity extends ActionBarActivity {
	...
	/**
	 * Method used to resolve dependencies provided by Dagger modules. Inject an
	 * object to provide every @Inject annotation contained.
	 * 
	 * @param object
	 *            to inject.
	 */
	...
	private void injectDependencies() {
		final TvShowsApplication tvShowsApplication = (TvShowsApplication) getApplication();
